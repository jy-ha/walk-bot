...
public class sc_GameManager_2leg : MonoBehaviour
{
    ...
    Text[] text_links = new Text[11];
    Text[] text_axis = new Text[2];
    Text text_round;
    Text text_reward;
    Text text_size_x;
    Text text_size_y;
    ...
    HingeJoint2D[] legs_axis = new HingeJoint2D[4];
    ...
    void Update()
    {
        if (b_round)
        {
            ...
            if (timer > 5.0f)
            {
                ...
                float leg_scale_factor = leg_scale_reference / links[leg_selected_index];
        ...
        else
        {
            ...
            if (b_find_new)
            {
                reward_last = 0.0f;
                leg_selected_index++;
                if (leg_selected_index == 13) leg_selected_index = 1;
                //leg_selected_index = Random.Range(1, 13);
                b_find_new = false;
            }
            ...
            for (int i = 0; i < 11; i++) legs_4[i].localScale = new Vector3(1.0f, links[i] / 10, 1.0f);
            for (int i = 0; i < 2; i++) legs_axis[i].connectedAnchor = new Vector2(links[11] / -500, links[12] / -500);
            for (int i = 2; i < 4; i++) legs_axis[i].connectedAnchor = new Vector2(links[11] / 500, links[12] / -500);
            for (int i = 0; i < 11; i++) text_links[i].text = links[i].ToString("0.0000");
            for (int i = 0; i < 2; i++) text_axis[i].text = links[11 + i].ToString("0.0000");
        }
    }
    ...
    void get_components()
    {
        ...
        edge_right = GameObject.Find("Robot/leg (2)/linkage (8)").transform;
    ...
    void initiallize()
    {
        ...
        text_links[0] = GameObject.Find("UI/crank/Value").GetComponent<Text>();
        text_links[1] = GameObject.Find("UI/link 0/Value").GetComponent<Text>();
        text_links[2] = GameObject.Find("UI/link 1/Value").GetComponent<Text>();
        text_links[3] = GameObject.Find("UI/link 2/Value").GetComponent<Text>();
        text_links[4] = GameObject.Find("UI/link 3/Value").GetComponent<Text>();
        text_links[5] = GameObject.Find("UI/link 4/Value").GetComponent<Text>();
        text_links[6] = GameObject.Find("UI/link 5/Value").GetComponent<Text>();
        text_links[7] = GameObject.Find("UI/link 6/Value").GetComponent<Text>();
        text_links[8] = GameObject.Find("UI/link 7/Value").GetComponent<Text>();
        text_links[9] = GameObject.Find("UI/link 8/Value").GetComponent<Text>();
        text_links[10] = GameObject.Find("UI/link 9/Value").GetComponent<Text>();
        text_axis[0] = GameObject.Find("UI/axis_x/Value").GetComponent<Text>();
        text_axis[1] = GameObject.Find("UI/axis_y/Value").GetComponent<Text>();
        ...
        //hinges = GameObject.Find("Robot/leg/linkage (4)").GetComponent<HingeJoint2D>();
